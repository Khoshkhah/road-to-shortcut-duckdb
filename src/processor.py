...
class ShortcutProcessor:
    ...
    def process_forward_phase2_consolidation(self):
        ...
        self.con.execute(f"""
            ...
            SELECT 
                from_edge, to_edge, MIN(cost) as cost, arg_min(via_edge, cost) as via_edge,
                FIRST(lca_res) as lca_res, FIRST(inner_cell) as inner_cell, FIRST(outer_cell) as outer_cell, FIRST(inner_res) as inner_res, FIRST(outer_res) as outer_res, FIRST(current_cell) as current_cell
